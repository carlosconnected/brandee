...
export function ChatInput({ value, onChange, onSend, disabled }: ChatInputProps) {
  ...
  return (
    <div className="flex items-end gap-2 px-4 pb-4 pt-2">
      <div className="flex flex-1 items-end gap-2 bg-input border border-divider rounded-2xl px-4 py-2.5 focus-within:border-brand transition-colors duration-150">
        <textarea
          ref={textareaRef}
          rows={1}
          value={value}
